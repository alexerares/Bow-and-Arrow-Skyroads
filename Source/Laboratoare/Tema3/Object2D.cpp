...
Mesh* Object2D::CreateScore(std::string name, glm::vec3 leftBottomCorner, float length, glm::vec3 color, bool fill)
{
	...
	std::vector<VertexFormat> vertices =
	{
		VertexFormat(corner + glm::vec3(0, 0.001, 0), color),
		VertexFormat(corner + glm::vec3(0, 1, 0), color),
		VertexFormat(corner + glm::vec3(-1, 1, 0), color),
		VertexFormat(corner + glm::vec3(-1, 0.001, 0), color)
	};
...
Mesh* Object2D::CreateFuel(std::string name, glm::vec3 leftBottomCorner, float length, glm::vec3 color, bool fill)
{
	glm::vec3 corner = leftBottomCorner;

	std::vector<VertexFormat> vertices =
	{
		VertexFormat(corner + glm::vec3(0, 0, 0.001), color),
		VertexFormat(corner + glm::vec3(0, 1, 0.001), color),
		VertexFormat(corner + glm::vec3(-1, 1, 0.01), color),
		VertexFormat(corner + glm::vec3(-1, 0, 0.01), color)
	};
