...
void Laborator5::Init()
{
	...
	camera->Set(glm::vec3(2, 2, 5.6), glm::vec3(2, 2, 6), glm::vec3(0, 1, 0));
	...
	projectionMatrix = glm::perspective(RADIANS(0), window->props.aspectRatio, 0.01f, 200.0f);
...
void Laborator5::Update(float deltaTimeSeconds)
{
	...
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(2, 2, 5));
	...
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(4.f, 1.5f, 0));
		modelMatrix = glm::rotate(modelMatrix, RADIANS(90.f), glm::vec3(2.f, 1.f, 0));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(1.2f, 1.5f, .4f));
		RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
	}

	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(1.f, 4.f, 0));
		modelMatrix = glm::rotate(modelMatrix, RADIANS(90.f), glm::vec3(.7f, 1.8f, 0));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(2.f, .9f, 3.4f));
		RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
	}
